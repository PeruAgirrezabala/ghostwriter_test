...
if(isset($_GET['tabla'])) {
    ...
    $campoBase = "nombre";
    //file_put_contents("kk.txt",$_GET['orden']);
    ...
    { 
        if (($valor == "") && ($valor2 == "")) {  
            ...
            if ($_GET['tabla'] == "erp_apps") {
             ...
             //file_put_contents("loadselecttarifas.txt", "SELECT ".$campo.", ".$campoBase." ".$campo2." ".$campo3." FROM ".$table." WHERE ".$campoWhere.$campoWhere2.$criteria." ORDER BY ".$ordenCampo.$orden);
