...
function loadSelectPreciosOferta(selectItem, tabla, campo, campowhere, valor) {
    var items="<option></option>";
    var selectItem = selectItem;
...
function loadOfertaDetalleInfo(id) {
    ...
    function(data) { 
        ...
        loadSelect("ofertamat_materiales","MATERIALES","id","categoria_id",data[0].categoria_id,"");
        $("#ofertamat_nombre").val(data[0].nombre); 
        $("#ofertamat_modelo").val(data[0].modelo); 
        $("#ofertamat_descripcion").val(data[0].descripcion);
        $("#ofertamat_preciomat").val(data[0].precio);
        $("#ofertamat_cantidad").val(data[0].cantidad);
        $("#ofertamat_pvp").val(data[0].pvp);
...
function loadPedidoDetalleInfo(id) {
    ...
    function(data) { 
        ...
        loadSelect("pedidodetalle_precios","MATERIALES_PRECIOS","id","proveedor_id",$("#pedidos_edit_proveedores").val(),"fecha_val", "material_id", data[0].material, "MATERIALES_PRECIOS.dto_material");
        setTimeout(function(){
...
function loadPrevisionInfo(id) {
    ...
    $.getJSON("/erp/loadPrevisionInfo.php", 
    {
       id: id 
    },
    function(data) { 
...
function loadIndicadorDetalle(id) {
    ...
    function(data) { 
        ...
        $("#indicador_desc").val(data[0].descripcion);
        $("#indicador_resultado").val(data[0].resultado);
