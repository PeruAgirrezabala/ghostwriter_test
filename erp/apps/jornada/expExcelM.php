...
//        $objWorkSheet->setTitle("$arMeses[$i]");
        ...
        AND 
            MONTH(CALENDARIO.fecha) = ".$_POST['monthNum']." 
        AND 
...
//    }
    /*/ Calculos de horas totales /*/
        ...
        $registros = horasCalendarioMes($_POST['yearNum'],$_POST['monthNum'],$_POST['idtrabajador']);
        $horasAtrabajarMes = $registros[2];
        // Calculo las horas trabajadas en el mes
        $registros = horasTrabajadasMes($_POST['yearNum'],$_POST['monthNum'],$_POST['idtrabajador']);
        ...
        $registros = horasVacacionesEsteMes($_POST['yearNum'],$_POST['monthNum'],$_POST['idtrabajador']);
        $horasVacacionesMes = $registros[0];
        $registros = horasRegularizadasMes($_POST['yearNum'],$_POST['monthNum'],$_POST['idtrabajador']);
    ...
    $fichero = $pathraiz.'/plugins/excel/exports/jornada'.$user.'_'.$fecha.'.xls';
    ...
    echo "/erp/plugins/excel/exports/jornada".$user."_".$fecha.".xls";
