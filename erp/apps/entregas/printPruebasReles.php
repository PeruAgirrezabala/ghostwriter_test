...
/*                float: right;
  ...
  <body>
    ...
    <div id='details'>
        ...
        <div id="pruebasReles" style="padding-top: 250px;">
        <?
        $sqlInfo="SELECT id, ensayo_id, titulo, descripcion, estado, fecha FROM ENSAYOS_INFO WHERE ensayo_id=".$_GET['id'];
        //file_put_contents("printProject.txt", $sql);
        $resInfo = mysqli_query($connString, $sqlInfo) or die("Error al consultar la INFO del Ensayo");
        $ahtml="";
        while ($rowInfo = mysqli_fetch_array($resInfo)) {
            $ahtml.='<div class="form-group">
                        <table class="table table-bordered tabla-resultados">
                            <thead>
                                <tr>
                                    <th class="text-left" style="width: 20%">'.$rowInfo[2].'</th>
                                    <th class="text-left"><b>AJUSTE: </b></th>
                                    <th class="text-left"><b>FECHA: </b>'.$rowInfo[5].'</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="bg-dark">
                                    <th scope="row" class="text-left" style="width: 20%; height: 30px;"><b>ESTADO: </b>'.$rowInfo[4].'</th>
                                    <td colspan="2" class="text-left" style="height: 30px">'.$rowInfo[3].'</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>';
            ...
            <table class="table table-bordered tabla-resultados">
                <thead>
                    <tr>
                        ...
                        <th class="text-left"><b>AJUSTE: </b></th>
                        <th class="text-left"><b>TIEMPO: </b></th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="bg-dark">
                        <th scope="row" class="text-left" style="width: 20%; height: 30px;"><b>RESULTADO: </b></th>
                        <td colspan="2" class="text-left" style="height: 30px"></td>
                    </tr>
                </tbody>
            </table>
        </div>
