    ...
    <div id='details'>
        ...
        <div class='titulo'>
            <div class='iz' colspan="2">
                    <h2 class='titdetalles'>INSTALLATION</h2>
                    <p>Installation: <? echo $instalacionNombre; ?></p><p>Address: <? echo $instalacionDireccion; ?></p><p>Technician: <? echo $nombreTecnico." ".$apellidosTecnico; ?></p><p>Date: <? echo $fecha; ?></p><p>Manufacturer:</p><p>Model:</p>
                </div>
            
                <div class='iz' colspan="2">
                    <h2 class='titdetalles'>TEST RESULTS</h2>
                    <p><? echo $descripcionEnsayo; ?></p>
                </div>
        ...
        while ($row = mysqli_fetch_array($res)) {
            ...
            if($grupoanterior!=$row[3]){ // Si hay que iniciar otro grupo
                $ahtml.='</tbody></table>
                        '.$cabezera.'
                        <h4>'.$row[4].'</h4>
                        <table class="table table-striped table-hover tabla-ensayos-info" id="grupo-'.$row[3].'">
                        <tbody>
                        <tr data-id="'.$row[0].'">
                            <td class="text-left">'.$row[2].'</td>
                            <td class="text-left">'.$estado.'</td>
