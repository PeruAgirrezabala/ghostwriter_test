...
<div class="form-group form-group-tools">
    <button class="button" id="add-entrega"><img src="/erp/img/add.png" height="20"></button>
    <button class="button" id="refresh_entregas"><img src="/erp/img/refresh.png" height="20"></button>
            ...
            <div class="modal-body">
                <div class="contenedor-form">
                    <form method="post" id="frm_new_entrega">
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label class="labelBefore">Fecha Entrega: <span class="requerido">*</span></label>
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="newentrega_estados" class="labelBefore">Estado: <span class="requerido">*</span></label>
                        ...
                        <div class="form-group"></div>
                        <div class="form-group">
                            <label for="newentrega_proyecto" class="labelBefore">Proyecto: <span class="requerido">*</span></label>
                            <select id="newentrega_proyecto" name="newentrega_proyecto" class="selectpicker" data-live-search="true">
                                <option></option>
                            </select>
                        </div>
