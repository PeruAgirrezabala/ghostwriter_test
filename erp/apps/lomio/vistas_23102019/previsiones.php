...
<table class="table table-striped table-hover table-condensed" id='tabla-previsiones' style="font-size: 9px !important;">
    <thead>
      <tr>
        ...
        <th class="text-left">PREVISIÓN</th>
        <th class="text-left">INSTALACION | CLIENTE</th>
    ...
    while ($registros = mysqli_fetch_array($resultado)) { 
        ...
        echo "
            <tr data-id='".$registros[0]."'>
                ...
                <td class='text-center'><button class='btn-default remove-prev' data-id='".$registros[0]."' title='Eliminar Previsión'><img src='/erp/img/remove.png' style='height: 20px;'></button></td>
            </tr>
        ";
    }
?>
