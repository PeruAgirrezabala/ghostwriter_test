...
<?
    ...
    $sql = "SELECT 
                ...
                (SELECT GROUP_CONCAT(CONCAT(erp_users.nombre,' ', erp_users.apellidos)) FROM erp_users, PREVISIONES_TECNICOS WHERE PREVISIONES_TECNICOS.erpuser_id = erp_users.id AND PREVISIONES_TECNICOS.prevision_id = prev AND erp_users.id = ".$_SESSION['user_session'].") as tecnicos,
    ...
    while ($registros = mysqli_fetch_array($resultado)) { 
        ...
        echo "
            <tr data-id='".$registros[0]."'>
                ...
                <td class='text-left'>".$registros[5]." - ".$registros[6]."</td>
                ...
                <td class='text-center label-".$registros[11]."'><span class='label label-".$registros[11]."'>".$registros[10]."</span></td>
                <td class='text-center'><button class='btn btn-circle btn-danger remove-prev' data-id='".$registros[0]."' title='Eliminar Previsión'><img src='/erp/img/cross.png' style='height: 20px;'></button></td>
            </tr>
        ";
    }
?>
