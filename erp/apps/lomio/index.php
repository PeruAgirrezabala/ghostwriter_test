...
<script>
	...
	$(document).ready(function() {
            ...
            $("#tabla-act > tbody tr").on("click", function() {
                window.open(
            ...
            $("#tabla-previsiones > tbody tr").on("click", function() {
                window.open(
                    "/",
                    '_blank' 
                );
            ...
            $("#tabla-ordenes > tbody tr").on("click", function() {
                window.open(
            ...
            $("#tabla-hitos > tbody tr").on("click", function() {
                window.open(
                    "/erp/apps/proyectos/view.php?id=" + $(this).data("id"),
                    '_blank' 
                );
            ...
            $("#tabla-detalles-pedidos > tbody tr").on("click", function() {
                window.open(
            ...
            $("#tabla-ensayos > tbody tr").on("click", function() {
                window.open(
            ...
            $("#tabla-doc-PER > tbody tr").on("click", function() {
                window.open(
                    "/erp/apps/prevencion/",
                    '_blank' 
                );
            });
            $("#tabla-jornada > tbody tr").on("click", function() {
                window.open(
                    "/erp/apps/jornada/",
                    '_blank' 
                );
            });
            $(".open-actividad").on("click", function() {
                window.open(
                    "/erp/apps/actividad/",
                    '_blank' 
                );
            });
            $(".open-previsiones").on("click", function() {
                window.open(
                    "/erp/",
                    '_blank' 
                );
            });
            $(".open-prl").on("click", function() {
                window.open(
                    "/erp/apps/prevencion/",
                    '_blank' 
                );
            });
            $(".open-jornada").on("click", function() {
                window.open(
                    "/erp/apps/jornada/",
                    '_blank' 
                );
...
<body>
    ...
    <section id="contenido">
        ...
        <div id="dash-header">
            <div class="one-column" style="min-height: 300px;max-height: 300px;">
                <h4 class="dash-title">
                    ACTIVIDAD / INTERVENCIONES <button class="btn btn-circle btn-default open-actividad" data-id="3" title="Actividades"><img src="/erp/img/external.png"></button>
                </h4>
                <hr class="dash-underline">
                <div id="dash-intervenciones" class="pre-scrollable">
                    <? include($pathraiz."/apps/lomio/vistas/actividad.php"); ?>
                </div>
            </div>
            <!-- PTE. QUITAR. ESTA UNIFICADO CON ACTIVIDAD 
            <div class="two-column" style="min-height: 300px;max-height: 300px;">
                <h4 class="dash-title">
                    PREVISIONES <button class="btn btn-circle btn-default open-previsiones" data-id="3" title="Home"><img src="/erp/img/external.png"></button>
                </h4>
                <hr class="dash-underline">
            ...
            <div class="two-column" style="min-height: 300px;max-height: 300px;">
                <h4 class="dash-title">
                    DOCUMENTACIÓN PRL <button class="btn btn-circle btn-default open-prl" data-id="3" title="Actividades"><img src="/erp/img/external.png"></button>
                </h4>
                <hr class="dash-underline">
                <div id="doc-per-container" class="pre-scrollable">
            ...
            <div class="two-column" style="min-height: 300px;max-height: 300px;">
                <h4 class="dash-title">
                    JORNADA LABORAL <button class="btn btn-circle btn-default open-jornada" data-id="3" title="Actividades"><img src="/erp/img/external.png"></button>
                </h4>
                <hr class="dash-underline">
                <div id="doc-per-container" class="pre-scrollable">
