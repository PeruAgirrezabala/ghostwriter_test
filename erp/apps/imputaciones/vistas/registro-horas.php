...
<table class="table table-striped table-hover" id='tabla-horas'>
    ...
    <?
        ...
        $sql = "SELECT 
                ...
                AND
                    MONTH(PROYECTOS_HORAS_IMPUTADAS.fecha) = ".$monthNum." 
                AND 
                    PROYECTOS_HORAS_IMPUTADAS.tecnico_id = ".$_SESSION['user_session']."
                ORDER BY 
                ...
                <div class="contenedor-form">
                    <form method="post" id="frm_edit_horas">
                        ...
                        <div class="form-group">
                            ...
                            <select id="horas_proyectos" name="horas_proyectos" class="selectpicker" data-live-search="true" data-width="33%">
                                <option></option>
                            </select>
                        </div>
                        <div class="form-group">
