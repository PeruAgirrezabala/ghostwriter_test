...
<div class="one-column">
                <div class="form-group form-group-calendario-meses">
                    ...
                    <div class="col-md-4">
                        <h4>LEYENDA COLORES: <button class="button" id="view-leyenda-colores" title="Ver leyenda Colores"><img src="/erp/img/noojo.png" height="20"></button></h4>
                        <div class="one-column" id="leyenda-colores" style="display: none;">
                            
                                <?
                                $db = new dbObj();
                                $connString =  $db->getConnstring();
                                $sql="SELECT ACTIVIDAD_CATEGORIAS.nombre, ACTIVIDAD_CATEGORIAS.color FROM ACTIVIDAD_CATEGORIAS";
                                $resultado = mysqli_query($connString, $sql) or die("Error al ejcutar la consulta de Actividad");
                                $count=0;
                                while($row = mysqli_fetch_array($resultado)){
                                    if($count/6){
                                        
                                    }
                                    echo '<div class="col-md-3"><label class="labelBefore">'.$row[0].':</label></div>';
                                    echo '<div class="col-md-3"><div style="height:30px; background-color:'.$row[1].'"></div></div>';
                                }
                                ?>
