<!-- proyectos activos -->
<table class="table table-striped table-hover" id='tabla-ultimas-mod'>
    <thead>
        <tr class="bg-dark">
            <th>REF</th>
            <th>TITULO</th>
            <th style="min-width: 35%;">CODIGO</th>
...
<?
    ...
    $sql = "SELECT 
                ...
                ORDER BY 
                    ACTIVIDAD.fecha_mod DESC
                LIMIT 10
            ";

    $resultado = mysqli_query($connString, $sql) or die("Error al ejcutar la consulta de Ultimas");
