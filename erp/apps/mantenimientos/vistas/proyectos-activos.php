...
<?
    ...
    $criteria="";
    $tabla="";
//    if ($_GET['year']&&$_GET['cli']) {
//        $criteriaLink = "&year=".$_GET['year']."&cli=".$_GET['cli'];
...
//    else
    ...
    if($_GET['exp']){
        $criteriaLink .= "&exp=".$_GET['exp'];
        $criteria .= "AND PROYECTOS.id=MANTENIMIENTOS_EXP.proyecto_id AND MANTENIMIENTOS_EXP.expediente_id=".$_GET['exp'];
        $tabla = ", MANTENIMIENTOS_EXP";
    }
    if(($_GET['year']=="") && ($_GET['cli']=="") && ($_GET['exp']=="")){
        $criteriaLink = "";
        $criteria = "AND
...
//    }
    ...
    $sql = "SELECT 
                ...
                FROM 
                    PROYECTOS, CLIENTES, PROYECTOS_ESTADOS, TIPOS_PROYECTO".$tabla."  
                WHERE 
    ...
    $resultado = mysqli_query($connString, $sql) or die("Error al ejcutar la consulta de Proyectos1");
    ...
    $resultado = mysqli_query($connString, $sql) or die("Error al ejcutar la consulta de Proyectos2");
