...
<div class="one-column" id="materialalmacen-filterbar" style="background-color: #5cb85c;">
    <div class="form-group form-group-filtros">
        <label for="filter_material_ref" class="col-sm-1 control-label labelFiltros">Ref ó Material: </label>
        <div class="col-xs-3" style="padding-top: 10px;">
            <input type='text'  id="filter_material_ref" name="filter_material_ref" class="form-control" data-live-search="true"></input>
