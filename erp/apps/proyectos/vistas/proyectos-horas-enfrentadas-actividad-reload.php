<!-- Horas Vendidas/Ordenes --> 
    ...
    <?
        ...
        $sqlVendidas = "SELECT 
                        ...
                        FROM 
                            TAREAS, PERFILES, PERFILES_HORAS, PROYECTOS_TAREAS, PROYECTOS  
                        WHERE 
...
<!-- Horas Imputadas --> 
    ...
    <?
        $sqlTrabajadas = "SELECT 
                            sum(ACTIVIDAD_DETALLES_HORAS.cantidad)
                        FROM 
        ...
        $resultadoColoresTrabajadas = mysqli_query($connString, $sqlColoresTrabajadas) or die("Error al ejcutar la consulta de Horas Trabajadas");
    ?>
