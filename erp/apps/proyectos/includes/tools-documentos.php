            ...
            <div class="modal-body">
                <div class="contenedor-form">
                    <form method="post" id="frm_proyecto_addgroup_doc">
                        ...
                        <div class="form-group">
                            <label class="labelBeforeBlack">Nombre:</label>
                            <input type="text" class="form-control" id="proyecto_gruposdocnombre" name="proyecto_gruposdocnombre" disabled>
                            <!-- No se peremite cambiar el nombre ya que habría un monton de errores.-->
                        </div>
                        <div class="form-group">
                            <label class="labelBeforeBlack">Descripcion:</label>
...
<div id="confirm_del_doc_model" class="modal fade">
    <div class="modal-dialog dialog_estrecho">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="contenedor-form">
                    <input type="hidden" name="del_doc_id" id="del_doc_id">
                    <input type="hidden" name="del_option_id" id="del_option_id">
                    <p>¿Estas seguro/a de que queires eliminar este documento?</p>
                </div>
            </div>
            <div class="modal-footer">
