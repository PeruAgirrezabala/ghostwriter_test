...
<div id="detalleint_adddoc_model" class="modal fade">
                ...
                <div class="contenedor-form">
                    <form method="post" id="frm_pedidodocs">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="intdetalle_docnombre" name="intdetalle_docnombre">
                        </div>
                        <div class="form-group">
                            <label class="labelBeforeBlack">Descripcion:</label>
                            <input type="text" class="form-control" id="intdetalle_docdesc" name="intdetalle_docdesc">
                        </div>
