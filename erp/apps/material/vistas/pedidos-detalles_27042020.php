                    ...
                    <form method="post" id="frm_edit_pedidodetalle">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                ...
                                <button type="button" class="btn btn-primary" id="btn_clienteProyecto" data-row-id="0">
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label for="pedidodetalle_proyectos" class="labelBefore"><span class="guia">7</span> Proyecto: </label>
...
<div id="selectmaterial_model" class="modal fade">
    <div class="modal-dialog dialog_estrecho" style="width: 30% !important;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                <button type="button" id="btn_save_material" class="btn btn-primary">Añadir</button>
            </div>
        </div>
    </div>
</div>
