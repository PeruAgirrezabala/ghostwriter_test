<?php
            ...
            $html .= "
                    <div id='details' class='clearfix'>
                        <table class='titulo'>
                              <tr>
                                  <td class='iz'>
                                        <h1>REF. SU PEDIDO: ".$registrospROV[10]."</h1>
                                        <div class='to'>A/TO:</div>
                                        <h2 class='name'>Invernadero Barrenetxe (Usargoiti)</h2>
                                        <div class='address'>Barrio Butrón, 16 BAJO 1 - Gatika</div>
                                        <div class='email'><a href='mailto:'></a></div>
                                        <div class='to'>At./Att.:</div>
                                        <h2 class='name'>Joseba y/o Hamet</h2>
                                  </td>
                                  <td class='ri'>
                                        <h1>ALBARÁN Nº: AL190094</h1>
                                        <h2>Fecha Envío: 2019-06-25</h2>
                                        <h2>Transportista: MRW</h2>
                                  </td>
                              </tr>
                        </table>
    ...
    $nombrefichero = "AL".(str_replace("/", "", $registrospROV[9])).".pdf";
    if ($pathpedido != "") {
