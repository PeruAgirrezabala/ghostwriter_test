    ...
    <div class="modal-dialog dialog_estrecho" style="width: 30% important;">
        <div class="modal-content">
                    ...
                    <form method="post" id="frm_new_plantilla">
                        ...
                        <div class="form-group">
                            <div class="col-xs-6" style="margin-bottom: 15px;">
                                ...
                                <select id="newplantilla_tipo" name="newplantilla_tipo" class="selectpicker" data-live-search="true">
                                    <option></option>
                                </select>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btn_del_plantilla_model" class="btn btn-primary">Eliminar</button>
...
<div id="confirmar_delete_plantilla_model" class="modal fade">
    <div class="modal-dialog dialog_estrecho" style="width: 30% !important;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" style="display: inline-block;">CONFIRMACIÓN ELIMINAR PLANTILLA</h4>
            </div>
            <div class="modal-body">
                <div class="contenedor-form">
                    <input type="hidden" class="form-control" id="newplantilla_delplan" name="newplantilla_delplan">
                        <div class="form-group">
                            <label class="labelBefore text-center">¿Estas seguro de que deseas eliminar la plantilla?</label>
                        </div>
                        <div class="form-group"></div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" id="btn_del_plantilla" data-id="" class="btn btn-danger">Eliminar</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
            </div>
        </div>
    </div>
