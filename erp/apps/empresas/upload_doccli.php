<?
    ...
    if (empty($_FILES['uploaddocs_cli'])) {
    ...
    $uploaddocs = $_FILES['uploaddocs_cli'];
    ...
    $sql = "SELECT nombre FROM CLIENTES WHERE id = ".$_GET['id_cliente'];
    file_put_contents("selectCLI.txt", $sql);
    $result = mysqli_query($connString, $sql) or die("Error al seleccionar el nombre del Cliente");
